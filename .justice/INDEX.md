...
| [[2026] LEXBY-FI 3](judgments/high-court/2026-LEXBY-FI-3.md) | first-instance | good-law | Where a feature is the load-bearing differentiator a first-time reader must grasp before adopting, the README must carry it prominently; the five-condition convening trigger list and a concise CDD explainer are such, and must be elevated front-and-centre via summary-with-pointer (canonical text stays in plugin/CLAUDE.md, README carries a tight summary expressly citing it; verbatim duplication forbidden). | vibe-justice-system repo (README information architecture) | s. 4, s. 5, s. 8, s. 11(d); extends [2026] LEXBY-FI 2 |
| [[2026] LEXBY-FI 4](judgments/high-court/2026-LEXBY-FI-4.md) | first-instance | good-law | A deterministic, token-free semantic retrieval index over the committed markdown is a permitted screening device under s. 12, not bloat, on three cumulative conditions: (1) index-not-replacement (markdown stays the sole source of law under s. 1; index derived, rebuildable, pointer-only, regenerated in the same act that amends the citator); (2) adoption gated on a pre-stated measured trigger and presently FORBIDDEN (corpus too small; demonstrated-need unmet); (3) cheaper token-free intermediates (grep pre-filter, tag-sharding) exhausted first. Until the gate trips the s. 8 duty is to monitor and report, not build. | vibe-justice-system repo (precedent storage + retrieval substrate) | s. 1, s. 8, s. 11(c), s. 12, s. 15, s. 19(5); VPR 2, VPR 8; extends [2026] LEXBY-FI 3 |
| [[2026] LEXBY-SC 3](judgments/supreme-court/2026-LEXBY-SC-3.md) | supreme | good-law | Four reforms (VARIED, 8:1): (1) the leapfrog is a reviewable executive routing act (vires/form only, deferential), proper only for foundational matters, express/recorded/reasoned, abuse cured by decline-and-remit, Sovereign law-making untouched; (2) two-sided hard-research intake is the content of the s. 3 symmetric case file at every tier (fast-path excepted, so it screens not bloats); (3) an apex-only observer admitted sparingly by the reviewing/leave authority; (4) permission to appeal vests in an independent leave-judge who never sat below; (5) a non-adjudicating per-turn watchdog is lawful (remind-only, never punish, else void); (6) a deterministic pre-commit citation-integrity gate is mandatory. | All repos (court procedure + enforcement substrate) | s. 1, s. 2, s. 3, s. 11, s. 12, s. 13, s. 17, s. 18; leapfrog; enacts s. 19, s. 20; confirms FI 1, CA 1, SC 1, SC 2 |
