...
Established. A real party (Lexby) and a live, consequential decision: whether and how to amend the README, the first document every adopter reads, to surface the asserted load-bearing differentiator. The fork presents genuinely competing principled answers and is forward-looking, not academic.
