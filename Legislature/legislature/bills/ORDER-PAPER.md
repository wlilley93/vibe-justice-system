...
| 27 | **VJS (Constitution and Machinery) Act 2026** | Fixes the canonical name VJS; mandates the four-branch layout (Constitution/Judicature/Legislature/Executive) + system-data-only public repo; the public-mechanics rule (ministry charters + registry schema public, contents private); renames MBWS->Ministry of Business, Engineering and Skills and Defence->Ministry of Data Security (reconciling Bill 21); assigns the refactoring + security suites to those ministries (amendable by SI); confirms the Standing Committee as SI maker; and the judgments-publication rule (the law of every judgment public, personal facts sealed, local judgments private). | **ENACTED** (Royal Assent 2026-06-06; passed committee 4/4, 2 drafting rounds) |
| 28 | **CASE-LAW (Drafting Authority) (Amendment) Act 2026** | Gives effect to [2026] REALM-SC 8 by amending CASE-LAW s. 3 to confirm that Lexby has no law-making or adjudicative drafting authority; adopted text derives force from the lawful organ, not from counsel's draft. | **ENACTED** (Royal Assent 2026-06-06; passed committee 4/4, 2 drafting rounds) |
| 29 | **Ministerial Policy Arm Act 2026** | Codifies the policy-arm process: ministries propose, the Standing Committee drafts, the Sovereign enacts, first-impression forks go to court, mechanics/principles are public and operational facts stay private. | **ENACTED** (Royal Assent 2026-06-06; passed committee 4/4, 1 drafting round) |
| 30 | **Multi-Jurisdiction and Community Record Act 2026** | Implements [2026] REALM-PC 17: installed repos subscribe by default to canonical VJS law, local sovereigns may become independent or federate elsewhere, Community Record publication is opt-in and anonymised, and tooling must distinguish canonical VJS from forks. | **ENACTED** (Royal Assent 2026-06-07; passed committee 4/4, 1 drafting round) |
| 31 | **Agent Loop (Harness and Determinism) Act 2026** | Consolidates the scattered agent-loop law: preloop legal-evidence plan, cdd-first deterministic route where available, prehook court and subagent forecast, answer or act within authority, posthook validity review, and Lexby self-referral question unless an exempt route is recorded. Source-equivalence is required before any source is marked superseded or retired. | **ENACTED** (Royal Assent 2026-06-08; conditional no-new-substantive-law assent; corrected title and focus; passed committee 4/4, 1 drafting round) |
| 32 | **Computer-First Realm Act 2026** | CONSTITUTIONAL. Founds VJS V2 as a computer-first successor realm: supersedes V1 as live runtime law while preserving V1 as Gazette and Archive; establishes the V2 lawpack and deterministic kernel as the runtime surface; entrenches Royal Assent as the constitutive gate against the computational legislature (s.14); preserves apex-singleness in continuity (s.15); enumerates and verifies the protective-floor carry-forward (Sch.2); declares one Gazette with two estates (publication constitutively inert); and bars V1 revival by silence (s.9). Drafted by the Standing Committee on the V2 Kernel Team's void first draft (REALM-SC 8); settled on [2026] REALM-PC 24 and [2026] REALM-SC 10. | **ENACTED** (Royal Assent 2026-06-09; passed committee 4/4, second draft on the void first draft). **Declaratory until commencement** - commences on satisfaction and recording of the Schedule 1 conditions (referral finding A). |
