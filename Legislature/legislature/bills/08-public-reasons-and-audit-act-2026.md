<!-- Bill 8 of 25 - Order Paper of the Realm. Drafted by the Standing Committee. -->
...
(3) Where a forward-referenced Act (Bills 5, 6, 7, 11, 13, 16, 18, 22) is not yet in force, the placeholder definitions in Schedule 1 govern and fall away under the savings provision in section 26 when that Act lands.
...
(7) **"Audit trail"** means a retained, queryable record of significant decisions and their reasons-records, held abstractly in the existing universal ledger and any store the realm later certifies; this Act does not hard-wire any single live register that does not yet exist.
...
(2) The Auditor-General is not a court, holds no jurisdiction over breach, and is not a second governance home (s. 14, s. 22(3)). It is the standing, office-level analogue of the per-turn turn-watchdog (s. 19(4)) and is bound by the same limit, a fortiori.
