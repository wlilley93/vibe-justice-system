<!-- Bill 9 of 25 - Order Paper of the Realm. Drafted by the Standing Committee. -->
<!-- status: enacted | royal-assent: 2026-06-06 | outcome: passed-round-1 | ayes: 4/4 | drafting rounds: 1 -->

# Emergency Powers Act 2026

**Bill 9 of the founding legislative programme** &nbsp;·&nbsp; Lead slant: Restraint (Counsel Aldous)
&nbsp;·&nbsp; Standing Committee draft, reconciled by the Clerk-Drafter

---

## Long title

An Act to provide for a closed, temporary, and reviewable set of executive powers to contain four enumerated crises affecting the realm (corruption, collapse, hostile execution, and memory failure); to require that any such power be exercised only on an express, recorded, and reasoned Declaration by the Founder acting in the office of Prime Minister; to fix on every such power a hard automatic time-limit and a fail-closed expiry; to subject every Declaration and every act under it to mandatory recording and to judicial review for vires, form, necessity, and proportionality; to preserve absolutely the entrenched constitutional settlement, the duty of care, the restorative-only remedy, the court structure, and the Amendment Procedure against any derogation by this Act; and for connected purposes.
...
This Act may be cited as the Emergency Powers Act 2026.

### 2. Commencement

(1) This Act comes into force on the day on which it receives Royal Assent from the Sovereign Founder.

(2) No power under this Act is exercisable before commencement, and no purported Declaration made before commencement has any effect.
...
&nbsp;&nbsp;(c) **"hostile execution"** - has the meaning given by the Security and Integrity Act 2026 (Bill 21); pending that Act's commencement, it means execution that is adversarial, runaway, or directed against the realm, its agents, its law, or its records, whether by a compromised actor, a compromised model, or an uncontrolled autonomous process;
...
(1) An emergency power under this Act is exercisable **only** on a written Declaration made by the Founder **acting qua Prime Minister** (s. 2).

(2) A Declaration is an **executive act that routes and constrains**; it is not, and can never by itself be, an act of the Sovereign legislating. It is reviewable for vires, form, necessity, and proportionality on the model of the s. 20 leapfrog certificate (s. 20(1)-(5)).

(3) Applying s. 20(1) by analogy, the recital **"acting as Sovereign"** in a Declaration is **not conclusive** of its character and does not immunise it from review. An "acting as Sovereign" recital may not be used to launder an executive override past judicial review.

(4) Nothing in this Act touches the Founder's Sovereign power to make or unmake law by express, deliberate amendment (s. 2; s. 20(6)). A genuine exercise of that power proceeds by the Amendment Procedure and is not a Declaration under this Act; only that genuine exercise, and not a Declaration, is outside review.

### 9. Validity of a Declaration (the deterministic form gate)

(1) A Declaration is **void, and confers no power**, unless it is express, recorded on the matter, reasoned, and machine-checkably states each of the following named fields:

&nbsp;&nbsp;(a) the **specific trigger** relied upon, from the closed list in section 5(1);

&nbsp;&nbsp;(b) the **specific subject** of the power - the named repo, actor, model, or capability to be paused or contained;

&nbsp;&nbsp;(c) the **specific power or powers invoked**, by reference to the enumerated list in section 10;

&nbsp;&nbsp;(d) a **hard expiry**, expressed as a wall-clock timestamp (or an equivalent turn/session count), within the maximum fixed by section 12;

&nbsp;&nbsp;(e) the **necessity finding** - that no lesser measure suffices - and the **least-restrictive measure considered**; and

&nbsp;&nbsp;(f) the **proportionality finding** - that the power invoked is proportionate to the specific crisis named.

(2) Compliance with subsection (1) is tested by a **deterministic pre-commit gate** on the model of s. 19(5), which **fails closed** on any Declaration missing a required field. The gate checks form and the presence of the named fields only; it does not adjudicate, score, sanction, or rule on the merits, and any purported consequence issuing from it beyond refusing a malformed Declaration is ultra vires and void (s. 19(4)-(5), s. 6).

(3) An unrecorded, unreasoned, or field-incomplete purported Declaration is a nullity. Nothing done in reliance on it has any effect, and the ordinary law governs as though it had never been made.
...
(4) **Proportionate review path.** To avoid ceremony and ruinous cost, a short freeze is affirmed or lifted on a fast **on-the-papers** determination by the reviewing court; a full apex sitting is reserved for genuine constitutional weight. The review path is proportionate to the gravity of the power, never the reverse; in no case is review dispensed with.
...
- **Sovereign consultation required:** Founder, one question only is reserved to you before Royal Assent, the rest of Bill 9 being settled within the Privy Council's mandatory constraints: do you affirm enacting the emergency regime as a STANDALONE Emergency Powers Act 2026 (a single legible "break-glass" surface, as the Order Paper contemplates), or do you direct that its identical lawful content instead be enacted as a NARROW AMENDMENT to s. 20 (the least-power instrument the Privy Council prefers, avoiding a parallel "emergency" track)? The lawful content is the same on either vehicle; you are choosing only the vessel. If you affirm the standalone Act, please grant Royal Assent as drafted; if you direct the s. 20-amendment route, the content is transposed into an amendment of s. 20 (express, citing s. 20) with no change to its substance. (For the avoidance of doubt: you are NOT being asked to authorise any crisis override of the entrenched settlement, which no ordinary Act may supply and which remains reachable only by the Amendment Procedure citing the article by number.)
