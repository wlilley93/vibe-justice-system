...
2. **Migrating existing V1-governed projects** (e.g. opbox): a Principal policy call. Per `ACT-007` it is local-Principal authority; reversible and low-blast per project. Decide whether and when.
