...
def theBook : List Instrument :=
  [ruling2026N6, actJudgmentIntegrity, actCitatorIntegrity, actRecordDiscipline, actGateIntegrity, genesisInstrument digest]

/-- The book's legitimacy is a compile-time theorem (§21.5). -/
theorem book_lawful : Lawful digest theBook :=
  Lawful.enact (Lawful.enact (Lawful.enact (Lawful.enact (Lawful.enact Lawful.genesis (by decide) (by decide)) (by decide) (by decide)) (by decide) (by decide)) (by decide) (by decide)) (by decide) (by decide)
