...
/-- [2026] VJS 11 — Ruling on constitution:policies-govern. Filed from case constitution (first-instance). Payload in .justice/judgments/. -/
...
/-- [2026] VJS 12 — Ruling on constitution:question-routing. Filed from case constitution (first-instance). Payload in .justice/judgments/. -/
...
/-- [2026] VJS 13 — Ruling on constitution:policy-store. Filed from case constitution (first-instance). Payload in .justice/judgments/. -/
...
/-- [2026] VJS 15 — Ruling on constitution:docket-mix-measurement. Filed from case constitution (first-instance). Payload in .justice/judgments/. -/
...
def theBook : List Instrument :=
  [ruling2026N15, ruling2026N14, ruling2026N13, ruling2026N12, ruling2026N11, ruling2026N10, ruling2026N9, ruling2026N8, ruling2026N7, ruling2026N6, actJudgmentIntegrity, actCitatorIntegrity, actRecordDiscipline, actGateIntegrity, genesisInstrument digest]

/-- The book's legitimacy is a compile-time theorem (§21.5). -/
theorem book_lawful : Lawful digest theBook :=
  Lawful.enact (Lawful.enact (Lawful.enact (Lawful.enact (Lawful.enact (Lawful.enact (Lawful.enact (Lawful.enact (Lawful.enact (Lawful.enact (Lawful.enact (Lawful.enact (Lawful.enact (Lawful.enact Lawful.genesis (by decide) (by decide)) (by decide) (by decide)) (by decide) (by decide)) (by decide) (by decide)) (by decide) (by decide)) (by decide) (by decide)) (by decide) (by decide)) (by decide) (by decide)) (by decide) (by decide)) (by decide) (by decide)) (by decide) (by decide)) (by decide) (by decide)) (by decide) (by decide)) (by decide) (by decide)
