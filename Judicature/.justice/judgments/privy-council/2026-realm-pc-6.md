...
# Holding (application of SC 3 to the harvest feedback loop)

Allowed. Findings from a scored run may be harvested to enhance the harness, on the same HOW/WHAT line SC 3 draws for prompts, plus one temporal discipline.
