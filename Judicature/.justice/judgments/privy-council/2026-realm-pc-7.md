...
per_incuriam: false
date: 2026-06-05
reconstituted_from: "lexby-harvey-fi-2-admissibility"
---

# [2026] REALM-PC 7

> Reconstituted into the provenance scheme from the previous-system source `lexby-harvey-fi-2-admissibility.md`. Body text retained verbatim; the citation is the new neutral citation. Status: **good-law**.
...
Binding authority applied: [2026] LEXBY-SC 3; honest-scoring limb per [2026] LEXBY-HARVEY-FI 1.

## Judgment
# [2026] LEXBY-HARVEY-FI 2 - Re Admissibility: the agent room and the marker room
...
1. Self-marking is admissible. Running the evaluator against the full rubric to see whether we passed is legitimate and expected. Constraints: mark with the real rubric (do not soften the judge), report the result as-is, score once on a fresh-citator run, do not re-run the same task for a better number ([2026] LEXBY-HARVEY-FI 1), and label the result as a self-reported public-set number, not a leaderboard placement.
