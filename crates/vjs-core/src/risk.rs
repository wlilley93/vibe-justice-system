...
//!
//! Harvested from Agent kernelB's exemplar (shell-metasyntax risk -> human approval). Risk is never a
...
/// otherwise-bounded command reach beyond its literal text (the kernelB metasyntax class).
