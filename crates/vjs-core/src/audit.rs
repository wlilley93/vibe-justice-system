...
//!
//! Adopts the Opbox kernel's append-only chained-event discipline into VJS. Every recorded
...
//! needs an externally pinned head (`head()`), exactly as the Opbox kernel pins its chain head.
