//! The curated duty-to-gate registry, split from report.rs when the s4(e)
//! tranches grew it past the structural-cleanliness ceiling (behavior-preserving;
//! the module boundary is the ceiling's cure, the registry is unchanged).
