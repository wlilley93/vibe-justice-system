<!-- Bill 4 of 25 - Order Paper of the Realm. Drafted by the Standing Committee. -->
...
**3. Consolidation and supersession (Schedule pattern).** The Schedule maps each section of this Code to the VPR rule and CASE-LAW article it codifies and declares the corresponding VPR / case-law text to cease INDEPENDENT effect where re-enacted, so that the VPR and the Code cannot drift into two procedures (Judicature Act Schedule 1 model). Any restatement that could drift from its source is void pro tanto.
...
**10. Disclosure and preservation (a door only).** A litigation hold operates ENTIRELY by reference to Bill 7 and CASE-LAW s. 19(5) (append-with-supersede; no power to erase): notice, contemporaneous reasons, an opportunity to seek a stay, and no irreversible deletion or bake-in while a review is live (s. 17(c); Bill 12 s. 12). Spoliation is a justiciable falling-below (s. 5) remedied restoratively (s. 6), never a sanction. Disclosure SUBSTANCE is Bill 22's; memory substance is Bill 7's; confidentiality and privilege are Bill 22's. No closed or secret docket and no closed-material proceedings are created (Bill 22 s. 11(3), s. 17(2)); relief or evidence an affected agent cannot see is barred (s. 3, s. 19(1)).
